...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Admin Dashboard"
        description="Governance health, operational exceptions, and organization analytics."
      />

      <SummaryRail items={kpiCards} />
        ...
        >
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-border bg-muted/20 p-4">
              ...
              <p className="text-sm text-muted-foreground">Published leave types available to employees.</p>
            </div>
          </div>
        </SurfaceSection>
