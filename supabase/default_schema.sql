...
--
-- HRMS Default Schema Compatibility Bundle
--
-- Generated from:
--   1) supabase/schema_snapshot.public.sql   (public schema state snapshot)
--   2) supabase/bootstrap_platform.sql       (non-public app platform artifacts)
--   3) supabase/bootstrap_defaults.sql       (idempotent app defaults)
--
-- Source of truth remains:
--   - supabase/migrations/
--

-- ===== BEGIN: public schema snapshot =====
...
-- ===== END: public schema snapshot =====

-- ===== BEGIN: platform bootstrap (non-public app artifacts) =====
...
-- ===== END: platform bootstrap =====

-- ===== BEGIN: app bootstrap defaults =====
