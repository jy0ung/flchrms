-- =============================================================================
-- Leave Core Phase 1 Hotfix 2
-- =============================================================================
-- Fixes second runtime ambiguity in leave_preview_request:
--   column reference "policy_set_id" is ambiguous
-- =============================================================================
...
BEGIN
  ...
  IF v_policy_set_id IS NOT NULL THEN
    ...
    WHERE c.policy_set_id = v_policy_set_id
