-- =============================================================================
-- Migration: admin_create_employee trim fix
-- Purpose:   Replace schema-qualified TRIM calls with BTRIM to avoid runtime
--            errors when executing admin_create_employee.
-- =============================================================================
